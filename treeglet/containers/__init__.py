...
class Frame(Widget):
    ...
    def set_group(self, value):
        ...
        self._bgroup    = OrderedGroup(order=0, parent=self._group)
    ...
    def _resize_(self, prev_width, prev_height, new_width, new_height):
        """
